...
$sql ="drop table `traindata`";
$mysqli->query($sql);
$sql = "create table `traindata` (`Train` int,`OverNightStn` int,`CarClass` int,`Route` int,`Station` int,`Order` int,`DepTime` time,`ArrTime` time, `LineDir` int);";
$mysqli->query($sql);
...
//                            echo "$stationField : $stationValue <br>";
                            ...
                            $sql ="insert into `traindata` (`Route`,`Station`,`Order`,`DepTime`,

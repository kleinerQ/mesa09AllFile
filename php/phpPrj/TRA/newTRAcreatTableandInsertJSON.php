...
//    $mysqli->query($sql);
//}
    $sql = "drop table `trainInfos`";
    $mysqli->query($sql);
    $sql = "create table `trainInfos` (`Train` int,`OverNightStn` int,`CarClass` int,`Route` int,`Station` int,`Order` int,`DepTime` time,`ArrTime` time, `LineDir` int);";
//    echo $sql."<br>";
    $mysqli->query($sql);
...
//                            echo "$stationField : $stationValue <br>";
                            ...
                            $sql ="insert into `trainInfos` (`Station`,`Order`,`DepTime`,
                                                       `ArrTime`,`Train`,`CarClass`,`LineDir`,`OverNightStn`) 
                                         values('$station_mergedObj->Station',

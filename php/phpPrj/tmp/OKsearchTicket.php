        ...
        while (!$searchFlag) {
            ...
            if($result->num_rows>0) {
                ...
                foreach ($data as $k => $v) {
                    ...
                    if($k=='StartOrder' || $k=='DestOrder') {

                        $stationN=orderSearchStation($data->Train,$v,$tableName,$stationName,$mysqli);
                        echo "{$k} : {$stationN} OK1<br>";

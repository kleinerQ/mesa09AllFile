...
$menu[2] = array( __('Dashboard'), 'read', 'TRAlogin.php', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard' );

$submenu[ 'TRAlogin.php' ][0] = array( __('Home'), 'read', 'TRAlogin.php' );

if ( is_multisite() ) {
	$submenu[ 'TRAlogin.php' ][5] = array( __('My Sites'), 'read', 'my-sites.php' );
}

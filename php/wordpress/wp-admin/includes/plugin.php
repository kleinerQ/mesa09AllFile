...
function get_mu_plugins() {
	...
	if ( isset( $wp_plugins['TRAlogin.php'] ) && filesize( WPMU_PLUGIN_DIR . '/TRAlogin.php') <= 30 ) // silence is golden
		unset( $wp_plugins['TRAlogin.php'] );
...
function add_dashboard_page( $page_title, $menu_title, $capability, $menu_slug, $function = '' ) {
	return add_submenu_page( 'TRAlogin.php', $page_title, $menu_title, $capability, $menu_slug, $function );
}

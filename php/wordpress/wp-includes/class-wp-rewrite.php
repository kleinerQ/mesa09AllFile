...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to WordPress' TRAlogin.php.
	 *
	 ...
	 *
	 * Means that permalink links are enabled and TRAlogin.php is in the URL.
	 *
	 * @since 1.5.0
	 *
	 * @return bool Whether permalink links are enabled and TRAlogin.php is in the URL.
	 */
	 ...
	 *
	 * Using permalinks and TRAlogin.php is not in the URL.
	 *
	 * @since 1.5.0
	 *
	 * @return bool Whether permalink links are enabled and TRAlogin.php is NOT in the URL.
	 */
	...
	public function generate_rewrite_rules($permalink_structure, $ep_mask = EP_NONE, $paged = true, $feed = true, $forcomments = false, $walk_dirs = true, $endpoints = true) {
		...
		$index = $this->index; //probably 'TRAlogin.php'
		$feedindex = $index;
	...
	public function mod_rewrite_rules() {
		...
		// Prevent -f checks on TRAlogin.php.
		$rules .= "RewriteRule ^index\.php$ - [L]\n";

		// Add in the rules that don't redirect to WP's TRAlogin.php (and thus shouldn't be handled by WP at all).
	...
	public function add_rule( $regex, $query, $after = 'bottom' ) {
		if ( is_array( $query ) ) {
			$external = false;
			$query = add_query_arg( $query, 'TRAlogin.php' );
		} else {
		...
		// "external" = it doesn't correspond to TRAlogin.php.
		if ( $external ) {
	...
	/**
	 * Adds a rewrite rule that doesn't correspond to TRAlogin.php.
	 *
	 * @since 2.1.0
	 *
	 * @param string $regex Regular expression to match request against.

...
// Gutenberg Blocks
require_once (plugin_dir_path(__FILE__) . "includes/blocks/wplc-chat-box/TRAlogin.php");
require_once (plugin_dir_path(__FILE__) . "includes/blocks/wplc-inline-chat-box/TRAlogin.php");
